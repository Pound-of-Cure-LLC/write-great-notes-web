...
"[project]/lib/swr-config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function localStorageProvider() {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        try {
            ...
            if (stored) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug('[SWR] Restored cache from localStorage:', initialCache.length, 'entries');
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('[SWR] Failed to restore cache:', error);
        }
    }
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        if (storedVersion !== String(CACHE_VERSION)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].info('SWR cache version mismatch, clearing cache');
        ...
        Object.keys(localStorage).forEach((key)=>{
            if (key.startsWith('appointments:') || key === 'lastScheduleDate') {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].info('Removing orphaned cache key:', key);
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        const persistCache = ()=>{
            try {
                ...
                const appCache = Array.from(map.entries()).filter((param)=>{
                    let [key, value] = param;
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug('[SWR] Cache persisted:', appCache.length, 'entries');
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].error('[SWR] Failed to persist cache:', error);
            }
        };
        ...
        map.set = (key, value)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].debug('[SWR] Cache set:', key.substring(0, 80), 'has data:', !!(value === null || value === void 0 ? void 0 : value.data));
            debouncedPersist();
            return result;
        };
        map.delete = (key)=>{
...
;
;
const buttonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", {
    variants: {
        variant: {
...
const Button = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"](_c = (param, ref)=>{
    let { className, variant, size, asChild = false, isLoading = false, loadingText, children, disabled, ...props } = param;
...
function createClient() {
    var _process_env_NEXT_PUBLIC_SUPABASE_URL;
    // Determine environment from URL to set appropriate cookie name
    const isDevelopment = (_process_env_NEXT_PUBLIC_SUPABASE_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_URL) === null || _process_env_NEXT_PUBLIC_SUPABASE_URL === void 0 ? void 0 : _process_env_NEXT_PUBLIC_SUPABASE_URL.includes('bqnmswezadsxxfbpugua');
...
async function apiClient(endpoint) {
    ...
    const claims = data === null || data === void 0 ? void 0 : data.claims;
    if (!claims) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            const redirectParam = shouldIncludeRedirect ? "?redirect=".concat(encodeURIComponent(currentPath)) : '';
            window.location.href = "/login".concat(redirectParam);
        }
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logger"].warn('API Client: Failed to get timezone:', error);
        }
    }
    // Add any existing headers
    if (options.headers) {
        Object.entries(options.headers).forEach((param)=>{
            let [key, value] = param;
    ...
    if (response.status === 503) {
        ...
        try {
            ...
            if (errorData.error === 'emr_configuration_error') {
                if ("object" !== 'undefined' && !options.suppressEMRModal) {
...
async function getTelemedUrl(appointmentId) {
    return apiGet("/appointments/".concat(appointmentId, "/telemed-url"));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/store/capabilitiesStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const useCapabilitiesStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        capabilities: null,
        isLoading: false,
        error: null,
        fetchCapabilities: async ()=>{
            ...
            try {
                ...
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])("/organizations/me/capabilities?_t=".concat(timestamp));
                set({
                    capabilities: data,
                    isLoading: false
                });
...
"[project]/components/EMRConfigErrorModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$capabilitiesStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/capabilitiesStore.ts [app-client] (ecmascript)");
;
...
function EMRConfigErrorModal() {
    ...
    const clearCapabilities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$capabilitiesStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCapabilitiesStore"])({
        "EMRConfigErrorModal.useCapabilitiesStore[clearCapabilities]": (state)=>state.clearCapabilities
    }["EMRConfigErrorModal.useCapabilitiesStore[clearCapabilities]"]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EMRConfigErrorModal.useEffect": ()=>{
            ...
            const handleEMRError = {
                "EMRConfigErrorModal.useEffect.handleEMRError": (event)=>{
            ...
            }["EMRConfigErrorModal.useEffect.handleEMRError"];
    ...
    const handleGoToSettings = ()=>{
        ...
        if (error === null || error === void 0 ? void 0 : error.redirect_url) {
...
_s(EMRConfigErrorModal, "0pG5dxU2IiuDiOIMuNqAN6pg0CU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$capabilitiesStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCapabilitiesStore"]
    ];
});
_c = EMRConfigErrorModal;
var _c;
__turbopack_context__.k.register(_c, "EMRConfigErrorModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$swr$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/swr-config.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$EMRConfigErrorModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/EMRConfigErrorModal.tsx [app-client] (ecmascript)");
"use client";
;
;
;
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SWRConfig"], {
                    value: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$swr$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["swrConfig"],
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$theme$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeProvider"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$EMRConfigErrorModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EMRConfigErrorModal"], {}, "emr-error-modal", false, {
                                fileName: "[project]/app/layout.tsx",
                                lineNumber: 36,
                                columnNumber: 13
                            }, this)
...
//# sourceMappingURL=_fa4f83d4._.js.map