                  ...
                  {[
                    ...
                    >
                      <Link
                        ...
                        className={`px-8 py-4 bg-card rounded-xl border text-foreground font-medium hover:border-primary hover:bg-primary/5 transition-all text-lg relative ${emr.upNext ? 'border-amber-500/50' : 'border-border'}`}
                      >
                        {emr.upNext && (
